...
final class Store: ObservableObject {
    ...
    /// Free tier allows this many total entry entries before the paywall appears.
    ...
    init() {
        ...
        entriesURL = support.appendingPathComponent("cycleline_entries.json")
        settingsURL = support.appendingPathComponent("cycleline_settings.json")
        load()
        if entries.isEmpty {
            seed()
        }
